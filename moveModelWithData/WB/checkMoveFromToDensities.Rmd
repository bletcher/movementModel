...
ggplot(byYRYSS, aes(section, meanBiomassByAreaYRYSS, color = factor(year))) +
  geom_point() +
  geom_line() +  
  facet_grid(river+isYOY~season, scales = "free")
...
ggplot(filter(cdWB,residB<100,residB>-100), aes(meanBiomassYRYSS,moved01)) + # aes(meanBiomassByAreaYRYSS,moved01)) +
  geom_jitter(size = 0.1,height = 0.15) +
  #xlim(c(-20,21)) +
  stat_smooth(method = "glm", method.args = list(family = "binomial"), se = F) +
  facet_grid(season~species, scales="free")

ggplot(filter(cdWB,residB<100,residB>-100), aes(meanBiomassByAreaYRYSS,moved01)) + # aes(meanBiomassByAreaYRYSS,moved01)) +
  geom_jitter(size = 0.1,height = 0.15) +
  #xlim(c(-20,21)) +
  stat_smooth(method = "glm", method.args = list(family = "binomial"), se = F) +
  facet_grid(season~species, scales="free")
